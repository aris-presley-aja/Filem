...
export default {
  ...
  methods: {
    getMovies() {
      axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=f9a3efe8c813e81a40a9b661bde37457&query=${this.search}&language=en-EN&include_adult=true`
      ).then(result => this.movies = result.data.results );

      axios.get(
        `https://api.themoviedb.org/3/genre/movie/list?api_key=f9a3efe8c813e81a40a9b661bde37457&language=en-EN`
